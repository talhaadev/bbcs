        ...
        <div class="section mt-4">
            ...
            <div class="transactions">
                ...
                <a href="app-transaction-detail.html" class="item">
                    <div class="detail">
                        <img src="/assets/user/images/1.jpg" alt="img" class="image-block imaged w48">
                        <div>
                ...
                <a href="app-transaction-detail.html" class="item">
                    <div class="detail">
                        <img src="/assets/user/images/2.jpg" alt="img" class="image-block imaged w48">
                        <div>
                            <strong>Apple</strong>
                ...
                <a href="app-transaction-detail.html" class="item">
                    <div class="detail">
                        <img src="/assets/user/images/avatar4.jpg" alt="img" class="image-block imaged w48">
                        <div>
