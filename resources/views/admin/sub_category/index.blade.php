...
<script>
    ...
    $(function () {
        ...
        $('body').on('click', '.editCouponCode', function () {
            ...
            $.get("{{ route('sub_category.index') }}" + '/' + sub_category_id + '/edit', function (data) {
        ...
        $('body').on('click', '.deleteCouponCode', function () {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('sub_category.store') }}" + '/' + sub_category_id,
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function validateForm() {
            ...
            var category_idInput = document.getElementById('category_id');
            ...
            if (category_idInput.value.trim() === '') {
                category_idError.textContent = 'Category is required.';
                return false;
            }
